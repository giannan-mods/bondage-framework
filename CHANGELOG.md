...
- Make the draining witch affliction removal work with Trinity and Charlotte.

### Fixed

- Automatic equipping and unequipping of the Pink Leotard should now work.
- Probabilities set in the config files no longer inverted.
...
- Support for Mizu's Full Menu Busts (needs an updated mod loader).
- Patch for having both Stickers and Recruitment enabled at the same time.
- Toggle to disable the Traveler's shop.

### Fixed

- Better positions for Charlotte and Trinity images.
...
- Allow the Hypnotist to actually apply the Thrall affliction.
- Prevent Jyla's Collar from being equipped when equipment is optimized.

## [0.1.2] - 2024-07-29

### Added

- Toggle to give the Hypnotist the ability to apply mind Afflictions.
- Variable to configure how likely it is for a trap to appear on map change.

- New Afflictions:
  - Thrall: Forced to wear a lewd outfit, enemies will command her against the party.

### Fixed

- Skills that should be able to target both dead and alive now actually can.
- Character sprites are also dynamically changed when naked.
- KawA.I.i will properly equip a denial belt.
